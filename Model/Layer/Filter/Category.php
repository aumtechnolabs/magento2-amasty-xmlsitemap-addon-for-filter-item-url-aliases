...
namespace AumTechnolabs\AmastyURLAliasToSiteMap\Model\Layer\Filter;
...
class Category extends AbstractFilter implements CustomFilterInterface
{
    ...
    public function __construct(
        ...
        \AumTechnolabs\AmastyURLAliasToSiteMap\Model\Layer\Filter\ItemFactory $amastyURLAliasToSiteMapFilterItemFactory,
        array $data = []
    ) {
        parent::__construct(
            $filterItemFactory,
        ...
        $this->_filterItemFactory = $amastyURLAliasToSiteMapFilterItemFactory;
    }
    ...
    protected function _getItemsData()
    {
        ...
        if (
            $this->configProvider->isHideFilterWithOneOption()
            && count($itemsData) == 1
