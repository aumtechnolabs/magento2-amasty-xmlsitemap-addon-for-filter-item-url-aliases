...
namespace AumTechnolabs\AmastyURLAliasToSiteMap\Helper;

use Amasty\Shopby\Model\Layer\Filter\Price;
use AumTechnolabs\AmastyURLAliasToSiteMap\Model\UrlBuilder as UrlBuilderInterface;
...
class UrlBuilder extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @return string
     */
    public function buildUrl(FilterInterface $filter, $optionValue, $amastyURLAliasToSiteMapCategoryId = null)
    {
        $this->filter = $filter;
        ...
        return $this->amUrlBuilder->getUrl($route, $params, false, $categoryId ?? (int)$amastyURLAliasToSiteMapCategoryId);
    }
